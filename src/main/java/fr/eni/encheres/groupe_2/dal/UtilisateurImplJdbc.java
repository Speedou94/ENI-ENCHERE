...
public class UtilisateurImplJdbc implements DAO<Utilisateur> {
        ...
        try(Connection cnx = ConnectionProvider.getConnection()) {
            ...
            if (!rs.next()){
                ...
                if (!psw.equals(password)){
                    ...
                    utilisateur = new Utilisateur(id,pseudo,nom,prenom,email,telephone,rue,codePostal,psw,credit,admin);
                }
            }
