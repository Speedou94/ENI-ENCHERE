...
<form method="post" action="${pageContext.request.contextPath}/utilisateurs/">
    <div class="form-new-user">
        <div class="input-container-left">
            <label> <fmt:message key="sign_up_pseudo" bundle="${message}"/>
                <input class="input" type="text" placeholder="<fmt:message key="sign_up_pseudo" bundle="${message}"/>"
                       name="pseudo" value="${login.pseudo}">
            </label>
            <label>
        ...
        <div class="input-container-right">
            <label>
                ...
                <input class="input" type="text" placeholder="<fmt:message key="sign_up_adress" bundle="${message}"/>"
                       name="rue" value="${login.rue}">
            </label>
            <label>
                <fmt:message key="sign_up_postal_code" bundle="${message}"/>
                <input class="input" type="text"
                       placeholder="<fmt:message key="sign_up_postal_code" bundle="${message}"/>" name="codePostal"
                       value="${login.codePostal}">
            </label>
            <label>
                <fmt:message key="sign_up_town" bundle="${message}"/>
                <input class="input" type="text" placeholder=" <fmt:message key="sign_up_town" bundle="${message}"/>"
                       name="ville" value="${login.ville}">
            </label>
            <c:if test="${empty login}">
                <label>
                    <fmt:message key="sign_up_password" bundle="${message}"/>
                    <input class="input" type="password"
                           placeholder="<fmt:message key="sign_up_password" bundle="${message}"/>" name="password">
                </label>
                <label>
                    <fmt:message key="sign_up_confirmation" bundle="${message}"/>
                    <input class="input" type="password"
                           placeholder="<fmt:message key="sign_up_confirmation" bundle="${message}"/>"
    ...
    <c:if test="${empty login}">
        ...
        <a href="${pageContext.request.contextPath}/encheres/" class="button is-danger"> <fmt:message
                key="sign-up-cancel" bundle="${message}"/></a>
        </div>
    </c:if>
    <c:if test="${!empty login}">
